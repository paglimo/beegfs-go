...
var (
	...
	ErrStubNotReadable         = errors.New("stub file was not readable")
	ErrStubUrlMalformed        = errors.New("stub file is malformed")
	ErrStubUrlMismatch         = errors.New("stub file url does match")
)
